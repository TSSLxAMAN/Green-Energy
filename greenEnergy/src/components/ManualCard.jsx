    ...
    const handleToggleRecommendations = () => {
        if (!hasGenerated) {
            const results = panelOptions.map(panel => {
                const quantity = Math.ceil(solarPanelSizeManual / panel.wattage);
                const totalCost = quantity * panel.price_inr;
                const breakEvenMonths =
                    dailySavingManual > 0 ? Math.ceil(totalCost / dailySavingManual) : '∞';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 text-white">
                <div className="bg-emerald-600 rounded-xl p-5 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold">{dailyEnergyReqManual.toFixed(2)} Wh</p>
                    </div>
                </div>
                <div className="bg-emerald-600 rounded-xl p-5 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold">{solarPanelSizeManual.toFixed(2)} W</p>
                    </div>
                </div>
                <div className="bg-emerald-600 rounded-xl p-5 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold">{backupLoadManual.toFixed(2)} Wh</p>
                    </div>
                </div>
                <div className="bg-emerald-600 rounded-xl p-5 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold">{batteryAhManual.toFixed(2)} Ah</p>
                    </div>
                </div>
                <div className="bg-emerald-600 rounded-xl p-5 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold">₹{dailySavingManual.toFixed(2)}</p>
                    </div>
                </div>
            </div>
